...
spec = spec_from_file_location("content_classifier_dataset", module_path)
dataset_module = module_from_spec(spec)
sys.modules.pop("dataset", None)
spec.loader.exec_module(dataset_module)
ContentClassifierDataset = dataset_module.ContentClassifierDataset


def test_dataset_tokenizes_and_returns_expected_keys():
    dataset = ContentClassifierDataset(
